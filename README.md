...
### 4. Full-Time Jobs Have Not Fully Recovered Proportionally — Job Quality Remains Below Pre-COVID Levels
Canada's full-time to part-time employment ratio stood at 4.26 in 2019, meaning for every part-time worker there were 4.26 full-time workers. COVID-19 disproportionately eliminated full-time positions, dropping average full-time employment from 1,544.3 to 1,483.7 thousand in 2020 while part-time work proved more resilient. Despite absolute employment numbers recovering strongly by 2022, the full-time to part-time ratio has not returned to its 2019 baseline — sitting at 4.50 in 2026. This signals that while more Canadians are employed, a proportionally larger share are in part-time roles compared to pre-pandemic norms, indicating a structural shift in job quality that raw employment numbers alone do not capture.

### 5. Canada's Participation Rate Never Recovered to Pre-Pandemic Levels
Canada's average labour force participation rate stood at 65.33% in 2019. The COVID-19 shock drove it down to 63.64% in 2020 as hundreds of thousands of Canadians exited the workforce entirely. While employment headcounts recovered strongly by 2022, the participation rate never returned to its pre-pandemic baseline — sitting at 64.30% in 2026, a full percentage point below 2019 levels. This persistent gap indicates that a meaningful share of working-age Canadians who left the labour force during the pandemic have not returned, masking the true scale of labour market weakness behind otherwise improving employment numbers.
